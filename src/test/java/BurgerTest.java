...
public class BurgerTest {
    ...
    public void addIngredientShouldBeAddInBurgerTest() {
        ...
        assertTrue("Ошибка. В список должен был добавиться ингредиент", burger.ingredients.size() != 0);
    }
    ...
    public void getReceiptBurgerReceiptShouldBeReturnedTest() {
        ...
        assertEquals("Ошибка. Чек сформировался некорректно" ,expectedResult, burger.getReceipt());
    }
